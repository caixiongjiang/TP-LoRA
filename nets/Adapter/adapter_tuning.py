from nets.Adapter.swin_transformer import swin_tiny_patch4_window7_224 as create_model_T_224
from nets.Adapter.swin_transformer import swin_small_patch4_window7_224 as create_model_S_224
from nets.Adapter.adapter import Adapter_CNN, Adapter
...
class Attention_block(nn.Module):
    ...
    def __init__(self, F_g, F_l, F_int):
        ...
        self.Att_adapter = Adapter_CNN(in_dim=F_g)
...
class Adapter_Tuning(nn.Module):
    ...
    def __init__(self, num_classes=21, pretrained=False, backbone="swin_T_224", embed_dim=96, base=64):
        ...
        # Adapter-CNN
        self.Adapter1 = Adapter_CNN(in_dim=filters[0])
        self.Adapter2 = Adapter_CNN(in_dim=filters[1])
        self.Adapter3 = Adapter_CNN(in_dim=filters[2])
        self.Adapter4 = Adapter_CNN(in_dim=filters[3])
    ...
    def frozen(self):
        ...
        for module in self.modules():
            if isinstance(module, Adapter_CNN):
...
if __name__ == '__main__':
    model = Adapter_Tuning(num_classes=3 + 1, pretrained=False, backbone="swin_T_224")
