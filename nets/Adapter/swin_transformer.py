...
from nets.Adapter.adapter import Adapter
...
class SwinTransformerBlock(nn.Module):
    ...
    def __init__(self, dim, num_heads, window_size=7, shift_size=0,
        ...
        # Adapter
        self.Adapter1 = Adapter(in_dim=dim)
        self.Adapter2 = Adapter(in_dim=dim, short_cut=True)
    ...
    def forward(self, x, attn_mask):
        ...
        # 增加Adapter
        attn_windows = self.Adapter2(attn_windows)
        ...
        x = shortcut + x
        xn = self.norm2(x)
        x = x + self.mlp(xn) + self.drop_path(0.5 * self.Adapter1(xn))
