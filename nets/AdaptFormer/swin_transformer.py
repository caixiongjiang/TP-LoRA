...
from nets.AdaptFormer.adaptformer_module import AdaptFormer_Adapter
...
class SwinTransformerBlock(nn.Module):
    ...
    def __init__(self, dim, num_heads, window_size=7, shift_size=0,
        ...
        # AdaptFormer
        self.adaptformer_adapter_mlp = AdaptFormer_Adapter(in_dim=dim)  # FP32
        self.scale = 0.1
    ...
    def forward(self, x, attn_mask):
        ...
        # AdaptFormer's FFN
        x = shortcut + self.drop_path(x)
        x = x + self.drop_path(self.mlp(self.norm2(x))) + self.adaptformer_adapter_mlp(self.norm2(x)) * self.scale
