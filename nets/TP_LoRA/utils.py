...
def read_config(config_file='/home/caixj/PycharmProjects/TP-LoRA/nets/TP_LoRA/config.yaml'):
...
def Update_TP_LoRA_Set(mlp_dim, lora_dim, act, in_location, out_location, file_path=r'/home/caixj/PycharmProjects/TP-LoRA/nets/TP_LoRA/config.yaml'):
...
def read_vector_from_json(size, dataset, file_name='/home/caixj/PycharmProjects/TP-LoRA/nets/TP_LoRA/prompt_vector.json'):
